          ...
          <>
            <Container className={classes.container}>
              <Box className={classes.box}>
                <Box>
                  <img alt="" src={img} className={classes.imgCartEmpty} />
                </Box>
                <Typography className={classes.typography}>Giỏ hàng của bạn còn trống</Typography>
                <Button
                  variant="contained"
                  size="small"
            ...
            <Grid item className={classes.top}>
              <Paper elevation={0} mt={2}>
                <Box className={classes.header}>
                  <Box className={classes.sp}>Sản Phẩm</Box>
                  <Box className={classes.dg}>Đơn Giá</Box>
                  <Box className={classes.sl}>Số Lượng</Box>
                  <Box className={classes.st}>Số Tiền</Box>
                  <Box className={classes.tt}>Thao tác</Box>
                </Box>
              </Paper>
            </Grid>
              ...
              <Paper elevation={0}>
                <Box className={classes.bottom}>
                  ...
                  <Box className={classes.sum}>
                    <Box className={classes.titleSumPrices}>Tổng thanh toán</Box>
                  ...
                  <Button
                    ...
                    variant="contained"
                    color="secondary"
                    style={{ height: '32px', marginTop: '14px' }}
                  >
                    Check Out
                  </Button>
                </Box>
